...
namespace TeaEstate
{
    // Member 01 — lets the logged-in user change their own password.
    // Verifies the old password, checks new == confirm, then UPDATEs the [User] row.
    //
    // The layout lives in ChangePasswordForm.Designer.cs (visual designer); this file
    // holds only the Save behaviour.
